...
class RepairsControllerTest < ActionController::TestCase
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post :create, repair: { cost: @repair.cost, date: @repair.date, mileage: @repair.mileage, shop: @repair.shop, vehicle_id: @repair.vehicle_id, work: @repair.work }
    end
  ...
  test "should update repair" do
    patch :update, id: @repair, repair: { cost: @repair.cost, date: @repair.date, mileage: @repair.mileage, shop: @repair.shop, vehicle_id: @repair.vehicle_id, work: @repair.work }
    assert_redirected_to repair_path(assigns(:repair))
  end
